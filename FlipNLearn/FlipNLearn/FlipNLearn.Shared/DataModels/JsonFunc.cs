...
namespace FlipNLearn.DataModels
{
    class JsonFunc
    {
        public static string jsonFileName = "set.json";

        public static void AddSet(Set set, ObservableCollection<Set> Sets)
        {
            if (!Sets.Any(s => s.Name == set.Name))
            {
                Sets.Add(set);
            }
        }
        ...
        async public static void Serialize()
        {
            ...
            //string jsonContents = JsonConvert.SerializeObject(DataModel.Sets);
        ...
        async public static void Deserialize()
        {
            ...
            //            {
            //                if (!DataModel.Sets.Any(s => s.Name == set.Name))
            //                {
            //                    DataModel.Sets.Add(set);

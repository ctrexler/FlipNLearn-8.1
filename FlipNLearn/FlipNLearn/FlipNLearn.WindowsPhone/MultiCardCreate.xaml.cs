...
namespace FlipNLearn
{
    ...
    /// </summary>
    public sealed partial class MultiCardCreate : Page
    {
        private NavigationHelper navigationHelper;
        private ObservableDictionary defaultViewModel = new ObservableDictionary();

        public MultiCardCreate()
        {
        ...
        {
            ViewModel.instance.SelectedDeck.Cards.Add(new Card() { Color = Colors.SteelBlue } );
        }

        private void Button_SaveCards_Click(object sender, RoutedEventArgs e)
        {
            JsonFunc.Serialize();
        }
